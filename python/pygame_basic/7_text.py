...
enemy_y_pos = (screen_height / 2) - (enemy_height / 2)#화면 가운데 아래
...
while running:
    ...
    #타이머 넣기
    elapsed_time = (pygame.time.get_ticks() - start_ticks) / 1000 #경과 시간을 천으로 나눠서 초로 표시
    timer = game_font.render(str(int(total_time - elapsed_time)), True, (255, 255, 255))#text, True, color
